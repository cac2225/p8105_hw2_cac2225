...
The number of observations in the final Mr. Trash dataset is 285. The number of observations in the final precip\_2016\_2017 dataset is 24. Key variables of the Mr. Trashy Wheel data set would be year, date and weight\_tons of trash collected since these tell you about the trends on when the most trash overall was collected. Key variables of the final precip\_2016\_2017 dataset would be year and precipitation since it's important to pinpoint when the most precipitation occurred. The total precipitation in 2017 was 72.88. The median number of sports balls in a dumpster in 2016 was 8.
