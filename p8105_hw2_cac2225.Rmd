...
precip_2016_2017 = 
  filter(___, state = (factor(state, levels = 1:50, labels = state.name)))
match
mode(state)
median(exellent)
```
...
ggplot(brfss_smart2010_clean, aes(x = year, y = Excellent)) + geom_histogram()

ggplot(weather_df, aes(x = year, y = excellent)) + 
  geom_point()
```
